...
export const defaultMetadata = {
  ...
  title: {
    default:
      'LotFit: Your Ultimate Clothing Marketplace',
    template: 'LotFit  | %s',
  },
  description:
    'Welcome to LotFit, your ultimate online shopping destination! We are your one-stop marketplace for a diverse range of products, all conveniently curated from a multitude of trusted sellers. ',
  keywords: metaKeywords.join(', '),
  // creator: 'SM Tanimur Rahman',
  // publisher: 'SM Tanimur Rahman',
  applicationName: 'LotFit',
  viewport: 'width=device-width, initial-scale=1.0',
  colorScheme: 'light',
  category: 'LotFit: Your Ultimate Clothing Marketplace',
  robots: {
    index: false,
    follow: true,
    nocache: true,
  ...
  openGraph: {
    ...
    //     width: 800,
    //     height: 600,
    //     alt: 'LotFit: Your Ultimate Clothing Marketplace',
    //   },
    // ],
