...
import logoblack from '../../../public/black-logo-lotfit.png';
  ...
  return (
    <header className=" lg:justify-between lg:w-full hidden lg:flex ">
      <div className="flex items-center w-full ">
        <Link href={"/"}>
          {/* <GradientLogo /> */}
          <div className="bg-gradient-to-r from-primary to-foreground bg-clip-text font-bold text-transparent md:text-2xl">
            <Image src={logoblack} alt={"404"}  width={100}
            />
          </div>
